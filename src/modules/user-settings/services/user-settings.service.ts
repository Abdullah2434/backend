...
import { UserVideoSettingsData } from "../types/user-settings.types";
...
export class UserVideoSettingsService {
  ...
  async saveUserVideoSettings(
    ...
    if (existingSettings) {
      ...
      if (!updatedSettings) {
        throw new ValidationError("Failed to update user video settings");
      }
...
export const userVideoSettingsService = new UserVideoSettingsService();
