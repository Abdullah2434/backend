...
export async function gallery(req: Request, res: Response) {
  try {
    ...
    const formattedVideos = videosWithUrls.map((video: any) => {
      // Ensure socialMediaCaptions includes all fields, even if null
    ...
    try {
      ...
      if (captions && typeof captions === "object") {
        ...
        try {
          ...
          if (pending?.captions) {
            console.log("📑 Found pending captions:", {
              hasInstagram: !!pending.captions.instagram_caption,
              hasFacebook: !!pending.captions.facebook_caption,
              hasLinkedIn: !!pending.captions.linkedin_caption,
              hasTwitter: !!pending.captions.twitter_caption,
