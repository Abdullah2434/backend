...
router.post("/top/posts", getInsights); // Get insights from SocialBu (protected)
router.get("/posts/scheduled", getScheduledPosts); // Get scheduled posts from SocialBu (public - uses shared token)
